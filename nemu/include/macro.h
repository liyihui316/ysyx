...
// if there is a comma in "contain_comma", a is the 2nd element.
#define MUX_MACRO_PROPERTY(p, macro, a, b) MUX_WITH_COMMA(concat(p, macro), a, b)
// define placeholders for some property
#define __P_DEF_0  X,
//the point is the comma.
#define __P_DEF_1  X,
// __P_DEF_0/1 means no matter define the macro 1 or 0, the output is both "a".
#define __P_ONE_1  X,
#define __P_ZERO_0 X,
...
#define BITMASK_J(bits) ((1ull << (bits)) - 2)
#define BITS(x, hi, lo) (((x) >> (lo)) & BITMASK((hi) - (lo) + 1)) // similar to x[hi:lo] in verilog
#define BITS_J(x, hi, lo) (((x) >> (lo)) & BITMASK_J((hi) - (lo) + 1))
